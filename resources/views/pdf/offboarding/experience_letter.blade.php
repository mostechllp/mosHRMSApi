...
<!-- BODY -->
<p class="body-para">
    This is to certify that <strong>{{ $empName }}</strong> (Employee Code: <strong>{{ $empCode }}</strong>)
    was employed with <strong>{{ $companyName }}</strong> and has served the organisation in the capacity mentioned below.
</p>
...
<p class="body-para">
    During their tenure, <strong>{{ $empName }}</strong> demonstrated professionalism, dedication, and a strong work ethic in fulfilling their duties. We wish them success in all future endeavours.
</p>

<p class="body-para">
    This letter is issued upon request of the employee for information and official purposes only.
</p>
