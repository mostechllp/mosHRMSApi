...
<head>
    ...
    <style>
        ...
        .doc-label {
            ...
            color: #0f3460; letter-spacing: 1.5px; text-transform: uppercase;
        }
        ...
        .addressed-to { margin-bottom: 18px; }
        .emp-name     { font-weight: bold; font-size: 11pt; color: #0f3460; }
        .emp-desig    { font-size: 9.5pt; color: #555; }
...
<table class="header-bar">
    <tr>
        ...
        <td class="doc-label">Resignation Acceptance</td>
    </tr>
</table>
...
<div class="addressed-to">
    ...
    <div class="emp-desig">Employee Code: {{ $empCode }}</div>
...
<p class="body-para">
    We acknowledge receipt of your resignation letter dated <strong>{{ $resignationDate }}</strong> and wish to inform you that
    <strong>{{ $companyName }}</strong> has formally accepted your resignation from the position
...
<div class="info-block">
    <table>
        <tr>
            <td class="ib-label">Resignation Tendered Date</td>
            <td class="ib-val">{{ $resignationDate }}</td>
        </tr>
        <tr>
            <td class="ib-label">Notice Period Required</td>
            <td class="ib-val">{{ $noticePeriodDays }} Days</td>
        </tr>
        <tr>
            <td class="ib-label">Notice Period Start Date</td>
...
<p class="body-para">
    You are requested to complete all handover activities, return all company property and assets assigned to you, and fulfill your responsibilities prior to your last working day.
</p>

<p class="body-para">
    We appreciate the contributions you have made during your tenure at {{ $companyName }} and wish you all the best in your future endeavours.
</p>
