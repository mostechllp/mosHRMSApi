...
<div class="subject-line">
    Subject: No Objection Certificate — {{ $empName }} ({{ $empCode }})
</div>
...
<p class="body-para">
    ...
    department at <strong>{{ $companyName }}</strong>, has formally separated from the organisation.
</p>
...
<p class="body-para">
    <strong>{{ $companyName }} has no objection</strong> to the above-named individual seeking employment elsewhere, pursuing higher studies, or completing official formalities as applicable. All dues and obligations of the organisation towards this individual have been settled in full.
</p>

<p class="body-para">
    We wish {{ $empName }} the very best in their future career.
</p>
